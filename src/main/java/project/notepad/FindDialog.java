...
public class FindDialog extends JPanel implements ActionListener {
  ...
  public FindDialog(JTextArea jta) {
     ...
     * 
     * buttonPanel.add(replaceButtonPanel,"replace"); buttonPanel.add(findButtonPanel,"find");
  ...
  int findNext() {
    ...
    if (up.isSelected()) {
      ...
      /*****
       * Notepad doesnt use the else part, but it should be, instead of using caretPosition.*** else
