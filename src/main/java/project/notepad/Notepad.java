...
class FileOperation {
  ...
  boolean newFileFlag;
  String fileName;
  String applicationTitle = "Notepad - Java Swing";
...
public class Notepad implements ActionListener, MenuConstants {
  ...
  JMenuItem cutItem, copyItem, deleteItem, findItem, findNextItem, replaceItem, gotoItem,
      selectAllItem;
  ...
  void showBackgroundColorDialog() {
    ...
    if (backgroundDialog == null)
      backgroundDialog = JColorChooser.createDialog(Notepad.this.f, formatBackground, false,
          bcolorChooser, new ActionListener() {
  ...
  void showForegroundColorDialog() {
    ...
    if (foregroundDialog == null)
      foregroundDialog = JColorChooser.createDialog(Notepad.this.f, formatForeground, false,
          fcolorChooser, new ActionListener() {
            public void actionPerformed(ActionEvent evvv) {
