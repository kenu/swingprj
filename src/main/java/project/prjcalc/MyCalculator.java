package project.prjcalc;

/*********************************************
 * Save this file as MyCalculator.java to compile it use javac MyCalculator.java to use the
 * calcuator do this java MyCalculator
 * 
 **********************************************/
...
public class MyCalculator extends Frame {
  ...
  MyCalculator(String frameText)// constructor
  {
    ...
    for (int i = 0; i < specialButton.length; i++) {
      specialButton[i] =
          new MySpecialButton(tempX, y, WIDTH * 2, HEIGHT, specialButtonText[i], this);
    ...
    for (int i = 0; i < operatorButton.length; i++) {
      tempX += WIDTH + H_SPACE;
      operatorButton[i] =
          new MyOperatorButton(tempX, y, WIDTH, HEIGHT, operatorButtonText[i], this);
  ...
  public static void main(String[] args) {
    new MyCalculator("Calculator - Java Swing");
  }
}
 ...
 * 
 * i) No coding done for "+/-" button. ii) Menubar is not included. iii)Not for Scientific
 * calculation iv)Some of the computation may lead to unexpected result due to the representation of
 * Floating point numbers in computer is an approximation to the given value that can be stored
